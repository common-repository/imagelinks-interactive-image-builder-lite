...
class ImageLinks_List_Table_Items extends WP_List_Table {
	...
	function column_date($item) {
		$m_time = mysql2date('Y/m/d g:i:s a', $item['date'], false);
		$h_time = mysql2date('Y/m/d', $item['date'], false);
	...
	function column_modified( $item ) {
		$m_time = mysql2date('Y/m/d g:i:s a', $item['modified'], false);
		$h_time = mysql2date('Y/m/d', $item['modified'], false);
